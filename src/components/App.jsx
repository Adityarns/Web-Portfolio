...
import Timeline from "./Reactbits/TimeLine.jsx";
...
export default function App() {
  return (
    <div className="text-center w-full h-screen ">
      {/* Hero */}
      <div className="items-center hero grid lg:grid-cols-2 grid-cols-1 pt-5 pb-10 md:py-48 xl:gap-0 gap-5 px-6 mx-auto animate__animated animate__fadeInUp animate__delay-0.5s">
      ...
      {/* About */}
      <div className="about py-20 px-6 max-w-6xl mx-auto md:px-10" id="about">
        ...
        <div data-aos="fade-up" data-aos-duration="1000" data-aos-once="true">
          <div className="pt-5 md:pt-7 items-start ">
            ...
            <div className="mb-10">
              <h2 className="text-3xl/tight font-bold text-left underline mb-6">
                Experience
              </h2>
              <Timeline experiences={experienceData} />

              {/* Text tambahan tetap ada di bawah */}
              <p className="text-sm md:text-lg text-black text-left md:text-justify mt-8">
                In addition to my technical pursuits, I am deeply involved in
                organizational leadership. These experiences have shaped my
                ability to lead teams, manage complex projects, and communicate
      ...
      {/* Skills */}
      <div className="tools  md:pt-14 px-6 max-w-6xl mx-auto">
        <h1
        ...
        <div className="tools-box md:mt-14 mt-5 grid lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-4">
          {listTools.map((tool) => (
            <div
              className="flex items-center gap-2 p-3 border border-[#3BC1A8] rounded-md hover:bg-black group hover:text-[#3BC1A8] transition-colors"
              data-aos="fade-up"
              data-aos-duration="1000"
      ...
      {/* Project */}
      <div
        className="Project pt-10 md:pt-14 px-6 max-w-6xl mx-auto"
        id="project"
      >
        <h1
          className="text-3xl/snug font-bold text-center md:text-left text-[#3BC1A8]"
      ...
      {/* Kontak */}
      <div
        className="kontak pt-10 md:pt-14 px-6 max-w-6xl mx-auto"
        id="contact"
      >
        <h1
          className="text-3xl/snug font-bold text-center md:text-left text-[#3BC1A8]"
        ...
        <form
          ...
          method="POST"
          className="bg-white p-10 sm:w-fit w-full mx-auto rounded-md border border-black mt-10"
          data-aos="fade-up"
          data-aos-duration="1000"
          data-aos-delay="300"
          data-aos-once="true"
